...
The *rdml* importer is an open source Wolfram package that allows the validation and import of the standard  [RDML](http://rdml.org) files generated by most of the widely used qPCR equipments. 
